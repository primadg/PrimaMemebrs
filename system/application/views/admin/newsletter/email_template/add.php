<!-- Newsletter Adding Email Templates -->

        <div class="body_header">
          <div style="float: left;"><img alt="Create template" src="<?php echo base_url();?>img/ico_c_template.png" width="32" height="32" /></div>
          <div class="header_pad">
            <div class="header_subject"><{admin_newsletter_email_templates_add_page_title}></div>
            <div class="header_comment"><{admin_newsletter_email_templates_add_page_desc}></div>
          </div>
        </div>
        ...
        <table class="settings" align="center" style="margin-top: 10px;">
    			<tr class="glav">
    				...
    				<td><input type="text" style="width: 400px;" maxlength="254" 
                    id="tpl_name" /></td>
    			</tr>
          <tr class="glav">
        ...
        <div class="after_table" style="padding-top: 10px;"><input type="button" class="button_big" value="<{admin_newsletter_email_templates_list_btn_add_template}>" onClick="add_template();" />&nbsp;<input type="button" class="button" value="<{admin_btn_cancel}>" onClick="email_template_list({})" /></div>
<br />
