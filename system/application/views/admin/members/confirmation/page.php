...
<!-- Confirmation page -->
        ...
        <div class="body_header">
          ...
          <div class="header_pad">
              <div class="header_subject"><{admin_member_control_confirm_suspend_label}></div>
              <div class="header_comment"><{admin_member_control_confirm_suspend_label_desc}></div>
          </div>
        </div>
        ...
        <table class="tab" align="center" width="700">
          <tr class="glav_big">
            ...
            <td>
            <a href="#" onClick = "load_unconfirmed_mbr_list({ord: 'by_login'});return false;">
            <{admin_member_control_confirm_suspend_table_login}>
            </a>
            <?php echo draw_arrow($sort_by, $order_by, 'by_login', true);?>
            </td>
            <td>
            <a href="#" onClick = "load_unconfirmed_mbr_list({ord: 'by_fullname'});return false;">
            <{admin_member_control_confirm_suspend_table_name}>
            </a>
            <?php echo draw_arrow($sort_by, $order_by, 'by_fullname');?>            
            </td>
            <td width="100">
            <{admin_member_control_confirm_suspend_table_action}>
            </td>
          </tr>
            <?php echo $rows;?>
        </table>
        ...
        <div class="add">
          <input type="button" class="button_big" 
            value="<{admin_member_control_confirm_suspend_button_confirm}>" 
            onClick="confirm_member_list();" />&nbsp;
          <input type="button" class="button_big" value="<{admin_member_control_confirm_suspend_button_suspend}>" onClick="suspend_member_list();" />
        </div>
