        ...
        <div class="body_header">
          <div style="float: left;"><img alt="<{admin_config_manage_news_add_label}>" src="<?php echo base_url();?>img/ico_add_field_big.png" width="32" height="32" /></div>
          <div class="header_pad">
            <div class="header_subject"><{admin_config_manage_news_add_label}></div>
            <div class="header_comment"><{admin_config_manage_news_add_label_desc}></div>
          </div>
        </div>
        ...
        <table class="settings" align="center">
    			<tr class="glav">
    				<td align="right"><{admin_config_manage_news_add_fields_date}>: <span style="color: red;">*</span></td>
	        ...
	        <tr class="glav">
	          ...
	          <tr class="glav">
    				<td align="right" valign="top"><{admin_config_manage_news_add_fields_brief}>: <span style="color: red;">*</span></td>
    				<td><textarea  id="news_brief" style="width: 400px; height: 70px;" class="noresize"><?php if(isset($brief)){echo $brief;}?></textarea></td>
    			</tr>
    			<tr class="glav">
    				<td align="right" valign="top" style="padding-top: 5px;"><{admin_config_manage_news_add_fields_content}>: <span style="color: red;">*</span></td>
    				<td>
                    <div class="resizable-textarea">   
                        <textarea  id="news_content" style="width: 400px; height: 150px;"><?php if(isset($content)){echo $content;}?></textarea>
                    </div>    
                    </td>
    			</tr>
    			<tr class="glav">
    				<td><{admin_config_manage_news_add_fields_for_members}>:</td>
        ...
        <div class="after_table" style="padding-top: 10px;">
          <input type="button" class="button" value="<{admin_config_manage_news_add_button_add}>" 
          onClick="add_news();" />&nbsp;
          <input type="button" class="button" value="<{admin_config_manage_news_add_button_cancel}>" onClick="load_news_list();" />
        </div>
        <br />
